...
\title{Examples of embedding Sage in \LaTeX{} with \ST}% \ST typesets the SageTeX name
...
With \textsf{\ST}, you can not only have Sage do your math for you,
...
\section{Plotting functions in Ti\emph{k}Z with \ST}
...
easy to use \ST{} to generate them. First you need a function that
